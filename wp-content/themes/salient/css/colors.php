...
function nectar_colors() {
	...
	article.post.quote .content-inner .quote-inner .whole-link, .iosSlider .prev_slide:hover, .iosSlider .next_slide:hover, body [class^="icon-"].icon-3x.alt-style.accent-color, body [class*=" icon-"].icon-3x.alt-style.accent-color, #slide-out-widget-area, #slide-out-widget-area-bg.fullscreen, 
    ...
    .portfolio-filters-inline[data-color-scheme="accent-color"] '.$woocommerce_main.'
	{
	...
	#footer-outer #flickr a:hover img, '.$social_accent_color_rounded.' #featured article .post-title a:hover, body #featured article .post-title a:hover, div.wpcf7-validation-errors {
	...
	body .col:not(#post-area):not(.span_12):not(#sidebar):hover .hovered .circle-border, body #sidebar .widget:hover .circle-border { border-color:'.$options["accent-color"].'; }
	...
	if(!empty($options["extra-color-1"])) { 
		...
		.portfolio-filters-inline[data-color-scheme="extra-color-1"], .pricing-table[data-style="flat-alternative"] .pricing-column.extra-color-1:before, .pricing-table[data-style="flat-alternative"] .pricing-column.highlight.extra-color-1 h3 .highlight-reason
		{
	...
	if(!empty($options["extra-color-2"])) { 
		...
		body .col:not(#post-area):not(.span_12):not(#sidebar):hover .extra-color-2.hovered .circle-border, body #sidebar .widget:hover .extra-color-2 .circle-border { border-color:'.$options["extra-color-2"].'; }
	...
	if(!empty($options["extra-color-3"])) { 
		...
		.portfolio-filters-inline[data-color-scheme="extra-color-3"], .pricing-table[data-style="flat-alternative"] .pricing-column.extra-color-3:before, .pricing-table[data-style="flat-alternative"] .pricing-column.highlight.extra-color-3 h3 .highlight-reason
		{
		...
		body .col:not(#post-area):not(.span_12):not(#sidebar):hover .extra-color-3.hovered .circle-border, body #sidebar .widget:hover .extra-color-3 .circle-border { border-color:'.$options["extra-color-3"].'; }
	...
	if(!empty($options['header-color']) && $options['header-color'] == 'custom') {
		...
		if(!empty($options['header-slide-out-widget-area-background-color'])) {
			echo '#slide-out-widget-area, #slide-out-widget-area-bg.fullscreen { background-color:'.$options['header-slide-out-widget-area-background-color'].'!important; }';
		}
